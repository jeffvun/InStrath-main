      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="row purchase-popup">
              <div class="col-12 stretch-card grid-margin">
                <div class="card card-secondary">
                  <span class="card-body d-lg-flex align-items-center">
                    <p class="mb-lg-0">Unauthorized access detected at Gate A, 2 false attempts at Gates B, and 5+ unchecked faces entered through Gate E </p>
                    <a href="#" class="btn btn-danger purchase-button btn-sm my-1 my-sm-0 ml-auto">Send Warning</a>
              ...
              <div class="col-md-12 grid-margin">
                <div class="card">
                  <div class="card-header d-block d-md-flex">
                    ...
                    <p class="ml-auto mb-0">How are your users trending overtime?<i class="icon-bulb"></i></p>
                  </div>
                  <div class="d-md-flex row m-0 quick-action-btns" role="group" aria-label="Quick action buttons">
                    ...
                    <div class="col-sm-6 col-md-3 p-3 text-center btn-wrapper">
                      <button type="button" class="btn px-0"><i class="icon-docs mr-2"></i>Edit User</button>
                    </div>
                    <div class="col-sm-6 col-md-3 p-3 text-center btn-wrapper">
                      <button type="button" class="btn px-0"><i class="icon-folder mr-2"></i>Upload photo</button>
                    </div>
                    <div class="col-sm-6 col-md-3 p-3 text-center btn-wrapper">
                      <button type="button" class="btn px-0"><i class="icon-book-open mr-2"></i>Create Face Avatar</button>
                    </div>
                  </div>
                </div>
              </div>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="d-sm-flex align-items-baseline report-summary-header">
                          <h5 class="font-weight-semibold">Secure Access Report Summary</h5> <span class="ml-auto">Updated Report</span> <button class="btn btn-icons border-0 p-2"><i class="icon-refresh"></i></button>
                        </div>
                      </div>
                    </div>
                    <div class="row report-inner-cards-wrapper">
                      <div class=" col-md -6 col-xl report-inner-card">
                        <div class="inner-card-text">
                          <span class="report-title">Verified</span>
                          <h4>1 203</h4>
                          <span class="report-count"> 30 min ago</span>
                        </div>
                      ...
                      <div class="col-md-6 col-xl report-inner-card">
                        <div class="inner-card-text">
                          <span class="report-title">Intrusion</span>
                          <h4>26</h4>
                          <span class="report-count"> 30 min ago</span>
                        </div>
                      ...
                      <div class="col-md-6 col-xl report-inner-card">
                        <div class="inner-card-text">
                          <span class="report-title">False Alert</span>
                          <h4>91</h4>
                          <span class="report-count"> 30 min ago</span>
                        </div>
                      ...
                      <div class="col-md-6 col-xl report-inner-card">
                        <div class="inner-card-text">
                          <span class="report-title">Visitor</span>
                          <h4>42</h4>
                          <span class="report-count"> 30 min ago</span>
                        </div>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row income-expense-summary-chart-text">
                      <div class="col-xl-4">
                        <h5>Intrusion And Verified Access Summary</h5>
                        <p class="small text-muted">A comparison of people who were legitimately accepted by the Secure Access System against those rejected or intruders (wrongly accepted). Learn more.</p>
                      </div>
                      <div class=" col-md-3 col-xl-2">
                        <p class="income-expense-summary-chart-legend"> <span style="border-color: #6469df"></span> Intruders </p>
                        <h3> 1,766</h3>
                      </div>
                      <div class="col-md-3 col-xl-2">
                        <p class="income-expense-summary-chart-legend"> <span style="border-color: #37ca32"></span> Verified </p>
                        <h3> 5,698</h3>
                      </div>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center mb-4">
                      <h4 class="card-title mb-sm-0">Penalised users </h4>
                      ...
                      <table class="table">
                        <thead>
                          <tr>
                            ...
                            <th class="font-weight-bold">Gate</th>
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <img class="img-sm rounded-circle" src="/assets/img/faces/face1.jpg" alt="profile image"> Karen Holmes
                            </td>
                            <td>Gate A</td>
                            <td>Ksh 500</td>
                            <td><img src="/assets/dashboard/alipay.png" alt="alipay" class="gateway-icon mr-2"> alipay</td>
                            <td>04 Jun 2022</td>
                            <td>12 Jul 2022</td>
                            <td>
                          ...
                          <tr>
                            <td>
                              <img class="img-sm rounded-circle" src="/assets/img/faces/face2.jpg" alt="profile image"> Miriam Otieno
                            </td>
                            <td>Gate E</td>
                            <td>Ksh 500</td>
                            <td><img src="/assets/dashboard/paypal.png" alt="alipay" class="gateway-icon mr-2"> Paypal</td>
                            <td>25 Jun 2022</td>
                            <td>07 Jul 2022</td>
                            <td>
                          ...
                          <tr>
                            <td>
                              <img class="img-sm rounded-circle" src="/assets/img/faces/face3.jpg" alt="profile image"> Romuald Sims
                            </td>
                            <td>Gate B</td>
                            <td>Ksh 500</td>
                            <td><img src="/assets/dashboard/alipay.png" alt="alipay" class="gateway-icon mr-2"> alipay</td>
                          ...
                          <tr>
                            <td>
                              <img class="img-sm rounded-circle" src="/assets/img/faces/face4.jpg" alt="profile image"> Caroline Muthan
                            </td>
                            <td>Gate A</td>
                            <td>Ksh 500</td>
                            <td><img src="/assets/dashboard/alipay.png" alt="alipay" class="gateway-icon mr-2"> alipay</td>
          ...
          <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
              <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © InStrath 2022
              </span>
            </div>
          </footer>
          <!-- partial -->
