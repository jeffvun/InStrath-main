            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="../../pages/samples/register.php">Edit Data</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-lg-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">System Error: False Rejection</h4>
                    <p class="card-description"> Existing students who were <code>denied access</code>
                    </p>
                    <table class="table">
                      <thead>
                        <tr>
              ...
              <div class="col-lg-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">System Error: Intrusion</h4>
                    <p class="card-description"> Student accounts associated with intruders who were <code>granted access</code>
                    </p>
                    <table class="table table-hover">
                      ...
                      <tbody>
                        <tr>
                          <td>Tatiana</td>
                          <td>119832</td>
                          <td class="text-success"> 0.00% <i class="icon-arrow-down-circle"></i></td>
                          <td><label class="badge badge-info">Fixed</label></td>
                        </tr>
                        <tr>
                          <td>Jess</td>
                          <td>123427</td>
                          <td class="text-danger"> 92.76% <i class="icon-arrow-up-circle"></i></td>
                          <td><label class="badge badge-danger">Pending</label></td>
                        </tr>
                        <tr>
                          <td>Marc</td>
                          <td>Flash</td>
                          <td class="text-danger"> 39.06% <i class="icon-arrow-up-circle"></i></td>
                          <td><label class="badge badge-warning">In progress</label></td>
                        </tr>
                        <tr>
                          <td>Peter</td>
                          <td>120329</td>
                          <td class="text-success"> 0.15% <i class="icon-arrow-down-circle"></i></td>
                          <td><label class="badge badge-success">Completed</label></td>
                        </tr>
                        <tr>
                          <td>Dave</td>
                          <td>115325</td>
                          <td class="text-danger"> 15.05% <i class="icon-arrow-down-circle"></i></td>
                          <td><label class="badge badge-warning">In progress</label></td>
                        </tr>
                      </tbody>
                    </table>
              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <p class="card-description"> Unrecorded people who have accessed the University premises as <code>visitors</code> after a failed authentification
                    </p>
          ...
          <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
              <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © InStraht 2022</span>
            </div>
          </footer>
          <!-- partial -->
        </div>
